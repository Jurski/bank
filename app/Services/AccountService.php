...
class AccountService {
    ...
    public function transfer(int $senderId, string $receiverAccountNumber, float $amount): void {
        // TODO:: try catch and research transaction begin?
        DB::transaction(function () use ($senderId, $receiverAccountNumber, $amount) {
            $sender = Account::findOrFail($senderId); // TODO:: create findAccount on model
            ...
            if($senderCurrency !== $receiverCurrency) {
                ...
                $sender->balance -= $amount * 100; // TODO:: create single method on model for this
